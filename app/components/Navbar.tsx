      ...
      <div className="container mx-auto max-w-6xl px-4">
        <div className="navbar__content flex items-center justify-between h-16">
          ...
          <nav className="nav__menu flex gap-8">
            ...
            <Link href="#portfolio" className="nav__link text-[var(--txt-2)] hover:text-[var(--gold-2)] transition">
              Portfolio
            </Link>
            <Link href="#skills" className="nav__link text-[var(--txt-2)] hover:text-[var(--gold-2)] transition">
              Skills
            </Link>
